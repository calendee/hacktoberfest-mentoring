...
These are the values to which people in the Hacktoberfest Project community should aspire:
...
- Depending on the severity/details of the incident, removing a harasser from membership of relevant Hacktoberfest Project organisations
